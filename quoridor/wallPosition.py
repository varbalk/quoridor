...
class WallPosition:
    ...
    def isOverlapping(self, otherWall):
        ...
        if self.column == otherWall.column and self.row == otherWall.row:
            return True
        # horizontal walls overlap if the rows are the same, and columns differ by 1
              ...
              (self.column == otherWall.column + 1 or 
               self.column == otherWall.column - 1) ): 
            return True
        # vertical walls overlap if the columns are the same, and rows differ by 1
              ...
              self.column == otherWall.column and 
